...
echo "     - restart the slurry process S3-Exe on the slurry spreader"
...
echo "* During first slurry process execution on the slurry spreader, not all services might be available."
