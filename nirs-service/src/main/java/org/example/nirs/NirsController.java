...
public class NirsController {
    ...
    @RequestMapping(value = "/nirs", method = RequestMethod.GET, produces = "application/json")
    @ResponseBody
    ...
    @RequestMapping(value = "/nirs", method = RequestMethod.POST, consumes = "application/json", produces = "application/json")
    @ResponseBody
